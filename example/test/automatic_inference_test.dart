...
void main() {
  group('Automatic Inference Tests', () {
    test(
      'should correctly infer required fields from constructor parameters',
      () {
    ...
    test(
      'should allow optional fields to be null (inferred from constructor)',
      () {
    ...
    test(
      'should handle nullable fields correctly (inferred from field types)',
      () {
        final dataWithNulls = {
          'id': 'test123',
          'name': 'Test Product',
