...
sealed class AckSchema<DartType extends Object> {
  ...
  /// Whether representation parsing would start from a cloned default value.
  @protected
  bool usesDefaultRepresentationInput(Object? inputValue) {
    return inputValue == null && defaultValue != null;
  }

  /// Resolves the source value used for representation parsing.
  @protected
  Object? resolveRepresentationInput(Object? inputValue) {
  ...
  /// Handles null representation inputs using the standard null/default flow.
  @protected
  SchemaResult<Object>? handleNullRepresentationInput(
    Object? inputValue,
    SchemaContext context,
  ) {
    if (inputValue != null) {
    ...
    return _representationResultFrom(failNonNullable(context));
  }
