...
typedef SchemaFactory<M> = SchemaModel<M> Function(Map<String, Object?>);
...
class SchemaRegistry {
  ...
  static void register<M, S extends SchemaModel<M>>(
    S Function(Map<String, Object?>) factory,
  ) {
  ...
  static SchemaModel? createSchema(Type modelType, Map<String, Object?> data) {
