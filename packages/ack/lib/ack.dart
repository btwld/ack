/// ACK — a bidirectional schema validation library for Dart.
///
/// Provides type-safe schema validation with a fluent API and explicit
/// boundary↔runtime conversion through [CodecSchema].
library;
