...
void main() {
  group('JSON Schema Default Emission Policy', () {
    ...
    test('Composite schemas should never emit top-level default', () {
      ...
      expect(anyOfJsonSchema.containsKey('default'), isFalse,
      ...
      expect(discJsonSchema.containsKey('default'), isFalse,
    ...
    test('Defaults in object properties (via Optional) should emit correctly',
        () {
      ...
      expect(withDefaultProp['default'], equals('default_value'),
      ...
      expect(required, isNot(contains('withDefault')),
