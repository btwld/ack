        ...
        outputs: {
          'test_pkg|lib/schema.g.dart': decodedMatches(
            allOf([
              ...
              contains('return statusSchema.parseRepresentationAs('),
              contains('return userSchema.safeParseRepresentationAs('),
        ...
        outputs: {
          'test_pkg|lib/schema.g.dart': decodedMatches(
            allOf([
              ...
              contains('return statusSchema.parseRepresentationAs('),
              contains('return statusSchema.safeParseRepresentationAs('),
              isNot(contains('_\$ackParse<')),
              isNot(contains('_\$ackSafeParse<')),
            ]),
          ),
