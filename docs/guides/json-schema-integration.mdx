...
| [`matches(p)`](../core-concepts/validation.mdx#matchesstring-pattern-string-example)             | `pattern: p`             | String                                 |
...
| [`enumString([...])`](../core-concepts/validation.mdx#enumstringliststring-allowedvalues)          | `enum: [...]`            | String                                 |
| [`min(n)`](../core-concepts/validation.mdx#minnum-limit)                 | `minimum: n`             | Number (Int/Double)                    |
| [`max(n)`](../core-concepts/validation.mdx#maxnum-limit)                 | `maximum: n`             | Number (Int/Double)                    |
...
| [`minLength(n)`](../core-concepts/validation.mdx#minlengthint-min)            | `minItems: n`            | List (Array)                           |
| [`maxLength(n)`](../core-concepts/validation.mdx#maxlengthint-max)            | `maxItems: n`            | List (Array)                           |
| [`unique()`](../core-concepts/validation.mdx#unique)          | `uniqueItems: true`      | List (Array)                           |
| [`nullable()`](../core-concepts/validation.mdx#nullable)             | `nullable: true`         | Any Type                               |
| `withDefault(v)`        | `default: v`             | Any Type (Note: Use `.withDefault()` on schema) |
| `describe(d)`         | `description: d`         | Any Type (Note: Use `.describe()` on schema) |
| [`Ack.integer`](../core-concepts/schemas.mdx#number)                | `type: integer`, `format: int64` | Type |
| [`Ack.double`](../core-concepts/schemas.mdx#number)             | `type: number`, `format: double`  | Type |
