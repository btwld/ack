...
schemas can validate. References to the 2020-12 meta-schema are reported as
unsupported: they are **not** treated as equivalent to accepting any JSON value.
