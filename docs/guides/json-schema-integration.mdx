...
| [`Ack.string().date()`](../core-concepts/validation.mdx#string-constraints) | `format: date` | String format validator |
| [`Ack.string().datetime()`](../core-concepts/validation.mdx#string-constraints) | `format: date-time` | String format validator |
| [`time()`](../core-concepts/validation.mdx#string-constraints) | `format: time` | String |
| [`Ack.string().uri()`](../core-concepts/validation.mdx#string-constraints) | `format: uri` | String format validator |
...
| [`Ack.date()`](../core-concepts/schemas.mdx#built-in-codecs) | `type: string`, `format: date` | Codec boundary shape |
| [`Ack.datetime()`](../core-concepts/schemas.mdx#built-in-codecs) | `type: string`, `format: date-time` | Codec boundary shape |
| [`Ack.uri()`](../core-concepts/schemas.mdx#built-in-codecs) | `type: string`, `format: uri` | Codec boundary shape |
| [`Ack.duration()`](../core-concepts/schemas.mdx#built-in-codecs) | `type: integer` | Codec boundary shape in milliseconds |
