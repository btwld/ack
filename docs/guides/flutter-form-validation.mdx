...
class _SignUpFormState extends State<SignUpForm> {
  ...
  final _usernameSchema = Ack.string
    ...
    .pattern(r'^[a-zA-Z0-9_]+$', message: 'Username can only contain letters, numbers, and underscores')
  ...
  final _passwordSchema = Ack.string
    ...
    .pattern(r'[A-Z]', message: 'Password must contain an uppercase letter')
    .pattern(r'[a-z]', message: 'Password must contain a lowercase letter')
    .pattern(r'[0-9]', message: 'Password must contain a digit')
