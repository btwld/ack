...
// ✅ Valid - age field can also be null (optional fields are inherently nullable)
final validData3 = {'name': 'John', 'age': null};
```

**Important:** `.optional()` fields are inherently nullable - they accept both missing values and null values.
