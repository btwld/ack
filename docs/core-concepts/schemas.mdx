...
Control handling of extra properties:
...
// Or use methods
final strict = baseSchema.strict(); // Reject extra properties
...
- [Validation Rules](./validation.mdx) - Complete constraint reference
- [Error Handling](./error-handling.mdx) - Handle validation errors
- [Custom Validation](../guides/custom-validation.mdx) - Create custom constraints
- [JSON Serialization](./json-serialization.mdx) - Validate JSON data
