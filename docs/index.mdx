...
<Warning style={{marginBottom: '2rem', padding: '1rem', textAlign: 'center'}}>
**PRERELEASE DOCUMENTATION**: You are viewing documentation for version {{ versions.default }} which is currently in prerelease. Some features may change before the final release.
</Warning>
