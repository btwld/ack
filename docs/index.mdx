...
- **[Nested validation](/core-concepts/schemas#object-schema)**: Validate deeply nested objects and lists
...
- **[Data transformation](/core-concepts/schemas#transformation)**: Transform validated data with `.transform()`
