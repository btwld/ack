...
- **[TypeSafe Models](/core-concepts/model-validation)**: Create type-safe models with automatic validation
...
Turn any Dart class into a validating model with annotations:
