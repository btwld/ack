...
- `AckSchema<T> description(String description)`: Adds a description (used by [`toOpenApi()`](../guides/openapi-integration.mdx)).
- `AckSchema<T> defaultValue(T value)`: Sets a default value (used by [`toOpenApi()`](../guides/openapi-integration.mdx)).
- [`AckSchema<T> constrain(...)`](../guides/custom-validation.mdx#applying-custom-constraints): Applies a custom validation constraint.
- [`Map<String, dynamic> toOpenApi()`](../guides/openapi-integration.mdx#generating-openapi-schemas): Converts the schema to an OpenAPI Schema Object map (requires `package:ack/openapi.dart`).
...
- [`pattern(...)`](../core-concepts/validation.mdx#patternstring-pattern--string-patternname-string-example)
...
**Property Annotations:** `@Required`, `@Nullable`, `@Description`, `@IsEmail`, `@IsUrl`, `@IsDate`, `@IsDateTime`, `@MinLength`, `@MaxLength`, `@Length`, `@Pattern`, `@IsNotEmpty`, `@EnumValues`, `@Min`, `@Max`, `@Positive`, `@Negative`, `@MultipleOf`, `@MinItems`, `@MaxItems`, `@UniqueItems`.
